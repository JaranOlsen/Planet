(function() {
  ...
  function generateMindmap() {
    const data = {
      nodes: [
        { id: "Type 7", group: 1 },
        { id: "Core Motivations", group: 2, parent: "Type 7" },
        { id: "Challenges", group: 2, parent: "Type 7" },
        { id: "Inner Work", group: 2, parent: "Type 7" },
        { id: "Growth Potential", group: 2, parent: "Type 7" },
        { id: "Practices", group: 2, parent: "Type 7" },
        { id: "Basic Desire: To be happy and satisfied", group: 3, parent: "Core Motivations" },
        { id: "Basic Fear: Being deprived or trapped in pain", group: 3, parent: "Core Motivations" },
        { id: "Core Need: To feel freedom and satisfaction", group: 3, parent: "Core Motivations" },
        { id: "Core Belief: The world rewards those who stay positive and explore opportunities", group: 3, parent: "Core Motivations" },
        { id: "Vice/Passion: Gluttony", group: 3, parent: "Challenges" },
        { id: "Fixation: Planning", group: 3, parent: "Challenges" },
        { id: "Trap: Escaping discomfort through distraction", group: 3, parent: "Challenges" },
        { id: "Avoidance: Pain or limitation", group: 3, parent: "Challenges" },
        { id: "Defense Mechanism: Rationalization", group: 3, parent: "Challenges" },
        { id: "Childhood Wound: Belief that love depends on staying happy and avoiding pain", group: 3, parent: "Inner Work" },
        { id: "Core Strategy: Seeking pleasure and avoiding discomfort", group: 3, parent: "Inner Work" },
        { id: "Inner Critic: Critiques for being trapped or missing out", group: 3, parent: "Inner Work" },
        { id: "Virtue: Sobriety", group: 3, parent: "Growth Potential" },
        { id: "Holy Idea: Workable Freedom", group: 3, parent: "Growth Potential" },
        { id: "Body-based", group: 3, parent: "Practices" },
        { id: "Movement Practices", group: 4, parent: "Body-based" },
        ...
        { id: "Mindfulness of Joy", group: 4, parent: "Discursive" },
        ...
        { id: "Awareness of Contentment", group: 4, parent: "Non-dual" },
        { id: "Dynamic Stillness", group: 4, parent: "Non-dual" } // From Methods.csv
      ],
      links: [
        { source: "Type 7", target: "Core Motivations" },
        { source: "Type 7", target: "Challenges" },
        { source: "Type 7", target: "Inner Work" },
        { source: "Type 7", target: "Growth Potential" },
        { source: "Type 7", target: "Practices" },
        { source: "Core Motivations", target: "Basic Desire: To be happy and satisfied" },
        { source: "Core Motivations", target: "Basic Fear: Being deprived or trapped in pain" },
        { source: "Core Motivations", target: "Core Need: To feel freedom and satisfaction" },
        { source: "Core Motivations", target: "Core Belief: The world rewards those who stay positive and explore opportunities" },
        { source: "Challenges", target: "Vice/Passion: Gluttony" },
        { source: "Challenges", target: "Fixation: Planning" },
        { source: "Challenges", target: "Trap: Escaping discomfort through distraction" },
        { source: "Challenges", target: "Avoidance: Pain or limitation" },
        { source: "Challenges", target: "Defense Mechanism: Rationalization" },
        { source: "Inner Work", target: "Childhood Wound: Belief that love depends on staying happy and avoiding pain" },
        { source: "Inner Work", target: "Core Strategy: Seeking pleasure and avoiding discomfort" },
        { source: "Inner Work", target: "Inner Critic: Critiques for being trapped or missing out" },
        { source: "Growth Potential", target: "Virtue: Sobriety" },
        { source: "Growth Potential", target: "Holy Idea: Workable Freedom" },
        { source: "Practices", target: "Body-based" },
        { source: "Body-based", target: "Movement Practices" },
        ...
        { source: "Discursive", target: "Mindfulness of Joy" },
        ...
        { source: "Non-dual", target: "Awareness of Contentment" },
