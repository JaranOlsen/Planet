(function() {
  ...
  function generateMindmap() {
    const data = {
      nodes: [
        { id: "Type 3", group: 1 },
        { id: "Core Motivations", group: 2, parent: "Type 3" },
        { id: "Challenges", group: 2, parent: "Type 3" },
        { id: "Inner Work", group: 2, parent: "Type 3" },
        { id: "Growth Potential", group: 2, parent: "Type 3" },
        { id: "Practices", group: 2, parent: "Type 3" },
        { id: "Basic Desire: To feel valuable and worthwhile", group: 3, parent: "Core Motivations" },
        { id: "Basic Fear: Being worthless or failing", group: 3, parent: "Core Motivations" },
        { id: "Core Need: To be valuable and successful", group: 3, parent: "Core Motivations" },
        { id: "Core Belief: The world rewards those who achieve and succeed", group: 3, parent: "Core Motivations" },
        { id: "Vice/Passion: Deceit", group: 3, parent: "Challenges" },
        { id: "Fixation: Vanity", group: 3, parent: "Challenges" },
        { id: "Trap: Over-achieving to prove worth", group: 3, parent: "Challenges" },
        { id: "Avoidance: Failure", group: 3, parent: "Challenges" },
        { id: "Defense Mechanism: Identification", group: 3, parent: "Challenges" },
        { id: "Childhood Wound: Belief that love depends on achievements and success", group: 3, parent: "Inner Work" },
        { id: "Core Strategy: Achieving and performing to gain value", group: 3, parent: "Inner Work" },
        { id: "Inner Critic: Critiques for not achieving enough", group: 3, parent: "Inner Work" },
        { id: "Virtue: Truthfulness", group: 3, parent: "Growth Potential" },
        { id: "Holy Idea: Hope", group: 3, parent: "Growth Potential" },
      ...
      links: [
        { source: "Type 3", target: "Core Motivations" },
        { source: "Type 3", target: "Challenges" },
        { source: "Type 3", target: "Inner Work" },
        { source: "Type 3", target: "Growth Potential" },
        { source: "Type 3", target: "Practices" },
        { source: "Core Motivations", target: "Basic Desire: To feel valuable and worthwhile" },
        { source: "Core Motivations", target: "Basic Fear: Being worthless or failing" },
        { source: "Core Motivations", target: "Core Need: To be valuable and successful" },
        { source: "Core Motivations", target: "Core Belief: The world rewards those who achieve and succeed" },
        { source: "Challenges", target: "Vice/Passion: Deceit" },
        { source: "Challenges", target: "Fixation: Vanity" },
        { source: "Challenges", target: "Trap: Over-achieving to prove worth" },
        { source: "Challenges", target: "Avoidance: Failure" },
        { source: "Challenges", target: "Defense Mechanism: Identification" },
        { source: "Inner Work", target: "Childhood Wound: Belief that love depends on achievements and success" },
        { source: "Inner Work", target: "Core Strategy: Achieving and performing to gain value" },
        { source: "Inner Work", target: "Inner Critic: Critiques for not achieving enough" },
        { source: "Growth Potential", target: "Virtue: Truthfulness" },
        { source: "Growth Potential", target: "Holy Idea: Hope" },
