(function() {
  ...
  function generateMindmap() {
    const data = {
      nodes: [
        { id: "Type 8", group: 1 },
        { id: "Core Motivations", group: 2, parent: "Type 8" },
        { id: "Challenges", group: 2, parent: "Type 8" },
        { id: "Inner Work", group: 2, parent: "Type 8" },
        { id: "Growth Potential", group: 2, parent: "Type 8" },
        { id: "Practices", group: 2, parent: "Type 8" },
        { id: "Basic Desire: To protect themselves and others", group: 3, parent: "Core Motivations" },
        { id: "Basic Fear: Being controlled or harmed", group: 3, parent: "Core Motivations" },
        { id: "Core Need: To be strong and self-reliant", group: 3, parent: "Core Motivations" },
        { id: "Core Belief: The world rewards those who are strong and take charge", group: 3, parent: "Core Motivations" },
        { id: "Vice/Passion: Lust (Excess)", group: 3, parent: "Challenges" },
        { id: "Fixation: Vengeance", group: 3, parent: "Challenges" },
        { id: "Trap: Being forceful to maintain control", group: 3, parent: "Challenges" },
        { id: "Avoidance: Vulnerability", group: 3, parent: "Challenges" },
        { id: "Defense Mechanism: Denial", group: 3, parent: "Challenges" },
        { id: "Childhood Wound: Belief that love depends on being strong and unyielding", group: 3, parent: "Inner Work" },
        { id: "Core Strategy: Asserting control and protecting the weak", group: 3, parent: "Inner Work" },
        { id: "Inner Critic: Critiques for showing weakness", group: 3, parent: "Inner Work" },
        { id: "Virtue: Innocence", group: 3, parent: "Growth Potential" },
        { id: "Holy Idea: Truth", group: 3, parent: "Growth Potential" },
        { id: "Body-based", group: 3, parent: "Practices" },
        { id: "Dynamic Movement", group: 4, parent: "Body-based" },
        ...
        { id: "Reflection on Power Dynamics", group: 4, parent: "Discursive" },
        ...
        { id: "Awareness of Softness", group: 4, parent: "Non-dual" },
        { id: "Dynamic Stillness", group: 4, parent: "Non-dual" } // From Methods.csv
      ],
      links: [
        { source: "Type 8", target: "Core Motivations" },
        { source: "Type 8", target: "Challenges" },
        { source: "Type 8", target: "Inner Work" },
        { source: "Type 8", target: "Growth Potential" },
        { source: "Type 8", target: "Practices" },
        { source: "Core Motivations", target: "Basic Desire: To protect themselves and others" },
        { source: "Core Motivations", target: "Basic Fear: Being controlled or harmed" },
        { source: "Core Motivations", target: "Core Need: To be strong and self-reliant" },
        { source: "Core Motivations", target: "Core Belief: The world rewards those who are strong and take charge" },
        { source: "Challenges", target: "Vice/Passion: Lust (Excess)" },
        { source: "Challenges", target: "Fixation: Vengeance" },
        { source: "Challenges", target: "Trap: Being forceful to maintain control" },
        { source: "Challenges", target: "Avoidance: Vulnerability" },
        { source: "Challenges", target: "Defense Mechanism: Denial" },
        { source: "Inner Work", target: "Childhood Wound: Belief that love depends on being strong and unyielding" },
        { source: "Inner Work", target: "Core Strategy: Asserting control and protecting the weak" },
        { source: "Inner Work", target: "Inner Critic: Critiques for showing weakness" },
        { source: "Growth Potential", target: "Virtue: Innocence" },
        { source: "Growth Potential", target: "Holy Idea: Truth" },
        { source: "Practices", target: "Body-based" },
        { source: "Body-based", target: "Dynamic Movement" },
        ...
        { source: "Discursive", target: "Reflection on Power Dynamics" },
        ...
        { source: "Non-dual", target: "Awareness of Softness" },
