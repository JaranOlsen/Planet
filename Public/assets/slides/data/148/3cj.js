(function() {
  ...
  function generateMindmap() {
    const data = {
      nodes: [
        { id: "Type 6", group: 1 },
        { id: "Core Motivations", group: 2, parent: "Type 6" },
        { id: "Challenges", group: 2, parent: "Type 6" },
        { id: "Inner Work", group: 2, parent: "Type 6" },
        { id: "Growth Potential", group: 2, parent: "Type 6" },
        { id: "Practices", group: 2, parent: "Type 6" },
        { id: "Basic Desire: To feel safe and secure", group: 3, parent: "Core Motivations" },
        { id: "Basic Fear: Being abandoned or without support", group: 3, parent: "Core Motivations" },
        { id: "Core Need: To have security and guidance", group: 3, parent: "Core Motivations" },
        { id: "Core Belief: The world rewards those who are vigilant and loyal", group: 3, parent: "Core Motivations" },
        { id: "Vice/Passion: Fear", group: 3, parent: "Challenges" },
        { id: "Fixation: Worry", group: 3, parent: "Challenges" },
        { id: "Trap: Over-preparing to feel safe", group: 3, parent: "Challenges" },
        { id: "Avoidance: Uncertainty", group: 3, parent: "Challenges" },
        { id: "Defense Mechanism: Projection", group: 3, parent: "Challenges" },
        { id: "Childhood Wound: Belief that love depends on being vigilant and prepared", group: 3, parent: "Inner Work" },
        { id: "Core Strategy: Seeking support and preparing for threats", group: 3, parent: "Inner Work" },
        { id: "Inner Critic: Critiques for not being careful or prepared enough", group: 3, parent: "Inner Work" },
        { id: "Virtue: Courage", group: 3, parent: "Growth Potential" },
        { id: "Holy Idea: Faith", group: 3, parent: "Growth Potential" },
        ...
        { id: "Contemplation of Safety", group: 4, parent: "Discursive" },
        { id: "Metta (Loving-Kindness)", group: 4, parent: "Discursive" },
        ...
        { id: "Focus on Breath Awareness", group: 4, parent: "Non-discursive" },
        { id: "Non-dual", group: 3, parent: "Practices" },
        { id: "Open Presence", group: 4, parent: "Non-dual" },
        { id: "Trust in Awareness", group: 4, parent: "Non-dual" },
        { id: "Dynamic Stillness", group: 4, parent: "Non-dual" } // From Methods.csv
      ],
      links: [
        { source: "Type 6", target: "Core Motivations" },
        { source: "Type 6", target: "Challenges" },
        { source: "Type 6", target: "Inner Work" },
        { source: "Type 6", target: "Growth Potential" },
        { source: "Type 6", target: "Practices" },
        { source: "Core Motivations", target: "Basic Desire: To feel safe and secure" },
        { source: "Core Motivations", target: "Basic Fear: Being abandoned or without support" },
        { source: "Core Motivations", target: "Core Need: To have security and guidance" },
        { source: "Core Motivations", target: "Core Belief: The world rewards those who are vigilant and loyal" },
        { source: "Challenges", target: "Vice/Passion: Fear" },
        { source: "Challenges", target: "Fixation: Worry" },
        { source: "Challenges", target: "Trap: Over-preparing to feel safe" },
        { source: "Challenges", target: "Avoidance: Uncertainty" },
        { source: "Challenges", target: "Defense Mechanism: Projection" },
        { source: "Inner Work", target: "Childhood Wound: Belief that love depends on being vigilant and prepared" },
        { source: "Inner Work", target: "Core Strategy: Seeking support and preparing for threats" },
        { source: "Inner Work", target: "Inner Critic: Critiques for not being careful or prepared enough" },
        { source: "Growth Potential", target: "Virtue: Courage" },
        { source: "Growth Potential", target: "Holy Idea: Faith" },
        ...
        { source: "Discursive", target: "Contemplation of Safety" },
        { source: "Discursive", target: "Metta (Loving-Kindness)" },
        ...
        { source: "Non-discursive", target: "Focus on Breath Awareness" },
        { source: "Practices", target: "Non-dual" },
        { source: "Non-dual", target: "Open Presence" },
        { source: "Non-dual", target: "Trust in Awareness" },
